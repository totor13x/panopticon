...
const callouts = {
  ...
  promardermurder: icons.zapIcon,
  promarderscientist: icons.zapIcon,
  promardermedic: icons.zapIcon,
  promardermurderhelper: icons.zapIcon,
  promardersherif: icons.zapIcon,
  promarderwajha: icons.zapIcon,
  promarderheadcrab: icons.zapIcon,
  promarderdressirovshik: icons.zapIcon,
  promarderdinara: icons.zapIcon,
  promarderded: icons.zapIcon,
  promarderalko: icons.zapIcon,
  promardervor: icons.zapIcon,
  promarderchicken: icons.zapIcon,
  promarderpsychonautar: icons.zapIcon,
  promardersuccub: icons.zapIcon,
  promardershut: icons.zapIcon,
  promardermoshennik: icons.zapIcon,
  promarderprodavec: icons.zapIcon,
  promarderminer: icons.zapIcon,
  promarderbulka: icons.zapIcon,
}
...
const calloutMapping: Record<string, keyof typeof callouts> = {
  ...
  quote: "quote",
  cite: "quote",
  promardermurder: "promardermurder",
  promarderscientist: "promarderscientist",
  promardermedic: "promardermedic",
  promardermurderhelper: "promardermurderhelper",
  promardersherif: "promardersherif",
  promarderwajha: "promarderwajha",
  promarderheadcrab: "promarderheadcrab",
  promarderdressirovshik: "promarderdressirovshik",
  promarderdinara: "promarderdinara",
  promarderded: "promarderded",
  promarderalko: "promarderalko",
  promardervor: "promardervor",
  promarderchicken: "promarderchicken",
  promarderpsychonautar: "promarderpsychonautar",
  promardersuccub: "promardersuccub",
  promardershut: "promardershut",
  promardermoshennik: "promardermoshennik",
  promarderprodavec: "promarderprodavec",
  promarderminer: "promarderminer",
  promarderbulka: "promarderbulka",
}
    ...
    externalResources() {
      ...
      if (opts.mermaid) {
        js.push({
          ...
          const darkMode = document.documentElement.getAttribute('current-theme') === 'dark'
          mermaid.initialize({
            startOnLoad: false,
            securityLevel: 'loose',
