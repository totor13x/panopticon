...
![](https://cdn.totor13x.co/images/stuffs/scripts/telegram-status-sync/ca5e8fda-44ea-4a83-958d-9b6219601e99.gif)
...
![](https://cdn.totor13x.co/images/stuffs/scripts/telegram-status-sync/2fab1c15-7e3d-491a-978c-7b66237081a8.png)
2. Далее нужно создать автоматизацию, я буду создавать для режима "Не беспокоить". В моем случае для скрипта это статус Work.
![](https://cdn.totor13x.co/images/stuffs/scripts/telegram-status-sync/05cb611b-096a-4891-bbd8-854e57c5e75d.jpg)
...
```
![](https://cdn.totor13x.co/images/stuffs/scripts/telegram-status-sync/f61bb6a4-3139-4f56-ad54-638ea1e341e0.gif)
