...
date: 2024-03-09
description: Telegram Emoji Sync - это скрипт на pyTelethon, который позволяет синхронизировать состояния фокусирования экосистемы Apple и при желании Discord.
...
![Демо проекта](https://cdn.totor13x.com/media/stuffs/scripts/telegram-status-sync/6e7f838a-2b9b-41be-900a-8edf502641de_1280x979_aXZjRkJZQ0paMVdabUhoZ2htbVlxKzlKKzQvbg==_aXZjRkJZQ0paMVdabUhoZ2htbVlxKzlKKzQvbg==.mp4)
...
![Скриншот команды](https://cdn.totor13x.com/media/stuffs/scripts/telegram-status-sync/e837a993-4c8e-438f-bbca-0459fda9f0c0_1280x1236_Ky9jQkI0QXdWbWw2ZUlkNWlKaDRaNGg0dEc5WCtZZ0M=.jpg)
2. Далее нужно создать автоматизацию, я буду создавать для режима "Не беспокоить". В моем случае для скрипта это статус Work.
![Скриншот автоматизации](https://cdn.totor13x.com/media/stuffs/scripts/telegram-status-sync/4dc4c60e-9b95-4f1f-8d35-1f6653583a54_1280x1078_RHhnT0JvQTJtQWQxZUlkeGlZaUpWNXBLM0gzUDdQYz0=.jpg)
...
![Демо результата](https://cdn.totor13x.com/media/stuffs/scripts/telegram-status-sync/6e7f838a-2b9b-41be-900a-8edf502641de_1280x979_aXZjRkJZQ0paMVdabUhoZ2htbVlxKzlKKzQvbg==_aXZjRkJZQ0paMVdabUhoZ2htbVlxKzlKKzQvbg==.mp4)
...
```
![Демо для BetterDiscord](https://cdn.totor13x.com/media/stuffs/scripts/telegram-status-sync/d47cad10-a479-49fd-a30b-9b52c1a58555_1280x1585_VE9jRkRnSWFtU1hHVmZoYW1VUjRsMmVWL0pqSWY0WT0=.mp4)
